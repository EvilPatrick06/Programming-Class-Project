...
def help_menu():
    ...
    5. Farkle: Dice game rules, scoring system, hot dice mechanics
...
7. Quit"""
    ...
    choice_input = turtle.textinput("Help Menu", "What would you like help with? (Enter 1-7 or game name)")
    ...
    if choice in ["1", "wordy"]:
        ...
        more_help()
    elif choice in ["5", "farkle"]:
        display_farkle_help()
        more_help()
    elif choice in ["6", "main", "menu", "main menu", "return"]:
        import main_menu
        main_menu.main_menu()
...
def display_farkle_help():
    farkle_help = """Farkle is a classic dice game where players push their luck to score points.

FARKLE BASIC RULES:
- Two players alternate turns
- Each player starts with 0 points
- First player to reach 1,500 points wins
- Each turn, you start with 6 dice

GAMEPLAY:
- Roll all available dice
- Select dice to keep for points
- Decide whether to bank your points or keep rolling
- If you roll and score 0 points, you "Womp Womp" and lose all points for that turn
...
- Single 1 = 100 points
- Single 5 = 50 points
- All other single dice = 0 points

HOT DICE RULE:
- If you use all 6 dice, you get 6 dice back to continue rolling
- This allows you to keep building your turn score

STRATEGY TIPS:
- Always save your 1s and 5s when possible
- Know when to stop rolling and bank your points
- The more dice you have, the safer your next roll
- Be cautious with fewer dice - higher risk of "Womp Womp"!

May the dice be in your favor!"""

    show_help_message("===== Farkle Help =====", farkle_help, wait_for_ok=False)
